...
const TestK8SCFTemplate = `# Copyright 2017 by the contributors
#
...
# service sshd restart
  ...
  ClusterSecGroupCrossTalk:
    Metadata:
      Comment: Open up all port into each machine
...
Outputs:
  MasterPublicIp:
    ...
    Value: !GetAtt K8sMaster.PublicIp

  MasterResourceId:
    Description: Resource Id of the master node.
    Value: !Ref K8sMaster

  WorkerResourceId:
    Description: Resource Id of the worker node.
